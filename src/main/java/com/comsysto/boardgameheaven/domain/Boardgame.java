...
public class Boardgame implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "boardgame_player",
               joinColumns = @JoinColumn(name="boardgames_id", referencedColumnName="ID"),
    ...
    public Boardgame players(Set<Player> players) {
        this.players = players;
        return this;
    }

    public Boardgame addPlayer(Player player) {
        players.add(player);
        player.getBoardgames().add(this);
        return this;
    }

    public Boardgame removePlayer(Player player) {
        players.remove(player);
        player.getBoardgames().remove(this);
        return this;
    }
