(function() {
    ...
    BoardgameDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Boardgame', 'Category', 'User'];

    function BoardgameDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Boardgame, Category, User) {
        var vm = this;
